...
contract ERC20Stakable is IStakable, ERC20 {
    ...
    uint256 internal _validatorsCount;
    uint256 internal _erasCount;
    Stakeholders.Stakeholder[] internal _stakeholders;
    mapping(address => uint256) internal _validatorsStakeholderIndexes;
    mapping(address => uint256) internal _stakeholdersIndexes;
